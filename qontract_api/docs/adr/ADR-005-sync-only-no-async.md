# ADR-005: Async/Sync Method Guidelines
...
The qontract-api service operates in multiple execution contexts:
...
3. **FastAPI-exclusive helpers**: Utilities like `tasks/utils.py` polling helpers
...
### Pattern 1: Async Endpoint with Sync Service
...
- ADR-003: Async-Only API with Blocking GET
- Implementation: `qontract_api/tasks/utils.py` (async helper)
