...
from qontract_api.integrations.slack_usergroups_v2.task import (
...
@router.post(
    ...
    operation_id="slack-usergroups-v2",
)
def slack_usergroups(
    reconcile_request: SlackUsergroupsReconcileRequestV2,
