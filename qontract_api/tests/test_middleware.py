...
def test_gzip_request_decompression(
    ...
    # Mock the get_slack_token function to avoid vault/env issues
    def mock_get_token(path: str) -> str:  # noqa: ARG001
        return "mock-token-123"

    # Import here to avoid circular dependency
    import qontract_api.integrations.slack_usergroups.router as router_module  # noqa: PLC0415

    monkeypatch.setattr(router_module, "get_slack_token_from_vault", mock_get_token)
...
def test_uncompressed_request_still_works(
    ...
    # Mock the get_slack_token function
    def mock_get_token(path: str) -> str:  # noqa: ARG001
        return "mock-token-123"
