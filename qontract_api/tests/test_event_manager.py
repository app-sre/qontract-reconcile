...
class TestEventManager:
    def test_publish_event(
        self, event_manager: EventManager, mock_publisher: MagicMock, sample_event: Event
    ) -> None:
    ...
    def test_from_config_disabled(self, mocker: MockerFixture) -> None:
        ...
        result = EventManager.from_config(cache=mock_cache, event_settings=mock_settings)
    ...
    def test_from_config_enabled(self, mocker: MockerFixture) -> None:
        ...
        mock_settings.stream_key = "test:events"
