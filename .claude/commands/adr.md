...
- ADRs are stored in `qontract_api/docs/adr/`
- Use the template from `qontract_api/docs/adr/ADR-000-template.md`
- Read `qontract_api/docs/adr/ADR-001-use-adrs-for-architecture-decisions.md` for the ADR process and what qualifies as an ADR.
...
- The README at `qontract_api/docs/adr/README.md` must list all ADRs

## Workflow

1. **Determine ADR Number:**
   - Check existing ADRs in `qontract_api/docs/adr/` to find the highest number
...
4. **Template Structure:**
   ...
   - Headers: Status, Date, Authors, Supersedes, Superseded by
   - Context section
...
5. **Update README:**
   - Add new ADR entry to the index table in `qontract_api/docs/adr/README.md`
