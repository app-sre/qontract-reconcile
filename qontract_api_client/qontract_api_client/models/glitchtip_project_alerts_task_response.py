...
T = TypeVar("T", bound="GlitchtipProjectAlertsTaskResponse")


@_attrs_define
class GlitchtipProjectAlertsTaskResponse:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        glitchtip_project_alerts_task_response = cls(
            id=id,
            status_url=status_url,
            status=status,
        )

        glitchtip_project_alerts_task_response.additional_properties = d
        return glitchtip_project_alerts_task_response
