...
T = TypeVar("T", bound="EscalationPolicyUsersResponse")


@_attrs_define
class EscalationPolicyUsersResponse:
    ...
    Attributes:
        ...
        Attributes:
            users (list[PagerDutyUser] | Unset): List of users in the escalation policy
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        escalation_policy_users_response = cls(
            users=users,
        )

        escalation_policy_users_response.additional_properties = d
        return escalation_policy_users_response
