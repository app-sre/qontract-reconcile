...
T = TypeVar("T", bound="LdapDirectSecret")


@_attrs_define
class LdapDirectSecret:
    ...
    Attributes:
        ...
        Attributes:
            base_dn (str): Base DN for LDAP searches
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        ldap_direct_secret.additional_properties = d
        return ldap_direct_secret
