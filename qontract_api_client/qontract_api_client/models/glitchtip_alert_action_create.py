...
T = TypeVar("T", bound="GlitchtipAlertActionCreate")


@_attrs_define
class GlitchtipAlertActionCreate:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        glitchtip_alert_action_create = cls(
            alert_name=alert_name,
            instance=instance,
            organization=organization,
            project=project,
        ...
        glitchtip_alert_action_create.additional_properties = d
        return glitchtip_alert_action_create
