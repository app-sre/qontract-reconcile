...
T = TypeVar("T", bound="AWSAccountManagerTaskResponse")


@_attrs_define
class AWSAccountManagerTaskResponse:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        aws_account_manager_task_response = cls(
            id=id,
            status_url=status_url,
            status=status,
        )

        aws_account_manager_task_response.additional_properties = d
        return aws_account_manager_task_response
