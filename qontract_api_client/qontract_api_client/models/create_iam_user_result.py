...
if TYPE_CHECKING:
    from ..models.account_create_iam_user_action import AccountCreateIAMUserAction


T = TypeVar("T", bound="CreateIAMUserResult")


@_attrs_define
class CreateIAMUserResult:
    ...
    Contains IAM user creation details.
        ...
        Attributes:
            ...
            actions (list[AccountCreateIAMUserAction] | Unset): IAM user creation actions performed
    ...
    status: TaskStatus
    actions: list[AccountCreateIAMUserAction] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _actions is not UNSET:
            ...
            for actions_item_data in _actions:
                actions_item = AccountCreateIAMUserAction.from_dict(actions_item_data)
        ...
        create_iam_user_result.additional_properties = d
        return create_iam_user_result
