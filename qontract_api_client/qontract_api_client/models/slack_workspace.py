...
class SlackWorkspace:
    ...
    Attributes:
        ...
        vault_token_path (str): Vault path to Slack workspace token (e.g., 'app-sre/integrations-output/slack-
            workspace-1/token')
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        vault_token_path = self.vault_token_path
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        vault_token_path = d.pop("vault_token_path")
