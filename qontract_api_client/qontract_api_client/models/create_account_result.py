...
if TYPE_CHECKING:
    from ..models.account_create_complete_action import AccountCreateCompleteAction


T = TypeVar("T", bound="CreateAccountResult")
...
class CreateAccountResult:
    ...
    On completion, contains the created account's name and UID.
        ...
        Attributes:
            ...
            actions (list[AccountCreateCompleteAction] | Unset): Completed account creation (empty while in progress)
    ...
    status: TaskStatus
    actions: list[AccountCreateCompleteAction] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _actions is not UNSET:
            ...
            for actions_item_data in _actions:
                actions_item = AccountCreateCompleteAction.from_dict(actions_item_data)
        ...
        create_account_result.additional_properties = d
