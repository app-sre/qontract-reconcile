...
T = TypeVar("T", bound="GithubOwnersTaskResponse")


@_attrs_define
class GithubOwnersTaskResponse:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        github_owners_task_response = cls(
            id=id,
            status_url=status_url,
            status=status,
        )

        github_owners_task_response.additional_properties = d
        return github_owners_task_response
