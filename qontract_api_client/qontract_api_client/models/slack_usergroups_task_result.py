...
if TYPE_CHECKING:
    ...
    from ..models.slack_usergroup_action_update_channels import (
        SlackUsergroupActionUpdateChannels,
    )
    from ..models.slack_usergroup_action_update_description import (
...
class SlackUsergroupsTaskResult:
    ...
    Contains the reconciliation results and execution status.
        ...
        Attributes:
            ...
            actions (list[SlackUsergroupActionCreate | SlackUsergroupActionUpdateChannels |
                SlackUsergroupActionUpdateDescription | SlackUsergroupActionUpdateUsers] | Unset): List of actions
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if not isinstance(self.actions, Unset):
            ...
            for actions_item_data in self.actions:
                ...
                if (
                    isinstance(actions_item_data, SlackUsergroupActionCreate)
                    or isinstance(actions_item_data, SlackUsergroupActionUpdateUsers)
                    or isinstance(actions_item_data, SlackUsergroupActionUpdateChannels)
                ):
                ...
                def _parse_actions_item(
                    ...
                    try:
                        if not isinstance(data, dict):
                            raise TypeError()
                        actions_item_type_2 = (
                            SlackUsergroupActionUpdateChannels.from_dict(data)
                        )
                    ...
                    if not isinstance(data, dict):
                        raise TypeError()
                    actions_item_type_3 = (
                        SlackUsergroupActionUpdateDescription.from_dict(data)
                    )
