...
T = TypeVar("T", bound="GlitchtipTaskResponse")


@_attrs_define
class GlitchtipTaskResponse:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        glitchtip_task_response = cls(
            id=id,
            status_url=status_url,
            status=status,
        )

        glitchtip_task_response.additional_properties = d
        return glitchtip_task_response
