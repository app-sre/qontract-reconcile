...
from ...models.create_account_result import CreateAccountResult
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/v1/integrations/aws-account-manager/create-account/{task_id}".format(
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = CreateAccountResult.from_dict(response.json())
...
def sync_detailed(
    ...
    *,
    ...
    """Aws Account Manager Create Status
