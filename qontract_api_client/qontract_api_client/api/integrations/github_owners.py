...
from ...models.github_owners_reconcile_request import GithubOwnersReconcileRequest
from ...models.github_owners_task_response import GithubOwnersTaskResponse
from ...types import Response


def _get_kwargs(
    *,
    body: GithubOwnersReconcileRequest,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v1/integrations/github-owners/reconcile",
    }
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 202:
        response_202 = GithubOwnersTaskResponse.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GithubOwnersTaskResponse]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        body (GithubOwnersReconcileRequest): Request model for github-owners reconciliation.
