...
from ...models.create_iam_user_result import CreateIAMUserResult
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/v1/integrations/aws-account-manager/create-iam-user/{task_id}".format(
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = CreateIAMUserResult.from_dict(response.json())
...
def sync_detailed(
    ...
    *,
    ...
    """Aws Account Manager Create Iam User Status
