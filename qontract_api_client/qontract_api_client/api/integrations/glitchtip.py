...
from ...models.glitchtip_reconcile_request import GlitchtipReconcileRequest
from ...models.glitchtip_task_response import GlitchtipTaskResponse
from ...types import Response


def _get_kwargs(
    *,
    body: GlitchtipReconcileRequest,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v1/integrations/glitchtip/reconcile",
    }
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 202:
        response_202 = GlitchtipTaskResponse.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    Args:
        body (GlitchtipReconcileRequest): Request model for Glitchtip reconciliation.
