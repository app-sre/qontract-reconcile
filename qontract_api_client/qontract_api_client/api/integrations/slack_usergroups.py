...
) -> HTTPValidationError | SlackUsergroupsTaskResponse | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[HTTPValidationError | SlackUsergroupsTaskResponse]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        HTTPValidationError | SlackUsergroupsTaskResponse
    """
