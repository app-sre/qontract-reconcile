...
@client.get("/api/v1/integrations/ocm-groups/reconcile/{task_id}")
async def ocm_groups_task_status(
    result: schemas.OcmGroupsTaskResult,
    task_id: str,
    timeout: int | None = None,
) -> schemas.OcmGroupsTaskResult:
    """Ocm Groups Task Status
