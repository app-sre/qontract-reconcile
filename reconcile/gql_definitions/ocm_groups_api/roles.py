...
class OcmGroupsApiRolesQueryData(ConfiguredBaseModel):
    roles: Optional[list[RoleV1]] = Field(..., alias="roles")


def query(query_func: Callable, **kwargs: Any) -> OcmGroupsApiRolesQueryData:
    """
    ...
    Returns:
        OcmGroupsApiRolesQueryData: queried data parsed into generated classes
    """
    raw_data: dict[Any, Any] = query_func(DEFINITION, **kwargs)
    return OcmGroupsApiRolesQueryData(**raw_data)
