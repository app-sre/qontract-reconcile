...
class AwsSamlRolesAwsAccountsQueryQueryData(ConfiguredBaseModel):
    accounts: Optional[list[AWSAccountV1]] = Field(..., alias="accounts")


def query(query_func: Callable, **kwargs: Any) -> AwsSamlRolesAwsAccountsQueryQueryData:
    """
    ...
    Returns:
        AwsSamlRolesAwsAccountsQueryQueryData: queried data parsed into generated classes
    """
    raw_data: dict[Any, Any] = query_func(DEFINITION, **kwargs)
    return AwsSamlRolesAwsAccountsQueryQueryData(**raw_data)
