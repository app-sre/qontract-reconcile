...
class SlackApi:
    ...
    def __init__(
        ...
        **chat_kwargs: Any,
        ...
        :param attach_filepath: file path to post as file upload with message (typically job log)
        ...
        def do_send(c: str, t: str) -> None:
            ...
            if self.attach_filepath is not None:
                try:
                    ...
                    logging.error(f"Slack API could not upload file {self.attach_filepath} to channel {self.channel}")
            else:
