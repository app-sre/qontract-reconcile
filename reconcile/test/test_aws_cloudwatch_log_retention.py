...
fxt = Fixtures("aws_cloudwatch_log_retention")
...
class TestAwsCloudwatchLogRetention:
    @staticmethod
    ...
    def setup_mocks(
        ...
        mocker.patch(
            "reconcile.aws_cloudwatch_log_retention.integration.get_aws_accounts_test",
    ...
    def test_run_with_unset_retention_log_group_and_matching_cleanup(
        ...
        mocked_aws_api = self.setup_mocks(
            mocker,
