...
def test_generate_rosa_creation_script_no_provisioning_shard(
    rosa_cluster_spec: OCMSpec, script_result_fixtures: Fixtures
) -> None:
...
def test_generate_rosa_creation_script_reuse_oidc(
    rosa_cluster_spec: OCMSpec, script_result_fixtures: Fixtures
) -> None:
...
def test_generate_rosa_creation_script_uwm_enable(
    rosa_cluster_spec: OCMSpec, script_result_fixtures: Fixtures
) -> None:
...
def test_generate_rosa_creation_script_private(
    rosa_cluster_spec: OCMSpec, script_result_fixtures: Fixtures
) -> None:
...
def test_generate_rosa_creation_script_dry_run(
    rosa_cluster_spec: OCMSpec, script_result_fixtures: Fixtures
) -> None:
