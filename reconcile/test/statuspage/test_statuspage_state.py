...
def test_s3_component_binding_state(state_mock: State) -> None:
...
def test_s3_component_binding_state_bind(state_mock: State) -> None:
    binding_state = S3ComponentBindingState(state_mock)
...
def test_s3_component_binding_state_forget(state_mock: State) -> None:
    binding_state = S3ComponentBindingState(state_mock)
