...
# ruff: noqa: SLF001, PLR2004, ARG001, S106
...
def test_slack_api_defaults(mock_webclient: MagicMock) -> None:
    """Test SlackApi uses default timeout and max_retries."""
    api = SlackApi("workspace", "token")
...
def test_slack_api_webclient_created_with_timeout(mock_webclient: MagicMock) -> None:
    ...
    SlackApi("workspace", "token", timeout=15)
...
def test_slack_api_retry_handlers_configured(mock_webclient: MagicMock) -> None:
    ...
    SlackApi("workspace", "token", max_retries=7)
...
def test_slack_api_workspace_name(mock_webclient: MagicMock) -> None:
    ...
    api = SlackApi("test-workspace", "token")
...
def test_usergroups_list_with_include_users_false(
    ...
    """Test usergroups_list passes include_users parameter."""
    mock_response: dict[str, Any] = {"usergroups": []}
    slack_api._sc.usergroups_list = MagicMock(return_value=mock_response)  # type: ignore[method-assign]

    slack_api.usergroups_list(include_users=False)

    slack_api._sc.usergroups_list.assert_called_once_with(include_users=False)
...
def test_usergroups_create_returns_slack_usergroup(
    ...
    usergroup = slack_api.usergroups_create(handle="newteam")
...
def test_usergroups_create_with_custom_name(
    ...
    slack_api.usergroups_create(handle="team", name="Custom Team Name")
...
def test_usergroups_update_returns_slack_usergroup(
    ...
    usergroup = slack_api.usergroups_update(
        usergroup_id="UG1",
        name="Updated Name",
        description="Updated description",
    )
...
def test_usergroups_users_update_returns_slack_usergroup(
    ...
    usergroup = slack_api.usergroups_users_update(
        usergroup_id="UG1",
        user_ids=["U1", "U2", "U3"],
    )
